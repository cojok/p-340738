...
import { ArrowRight, ArrowDown, ExternalLink, Target, FileText, HelpCircle } from "lucide-react";
        ...
        {isMobile ? (
          <Drawer>
            <DrawerTrigger asChild>
              <div className="bg-[#F1F0FB] p-6 rounded-2xl hover:bg-[#E8E6F8] transition-colors cursor-pointer">
            ...
            <DrawerContent>
              ...
              <div className="px-4 pb-4">
                <PageContent pageType={sectionType} />
              </div>
              <DrawerFooter>
                <DrawerClose className="w-full">
                  <button className="w-full py-2 border border-gray-300 rounded-md text-center">Close</button>
                </DrawerClose>
              </DrawerFooter>
            </DrawerContent>
          </Drawer>
  ...
  return (
    <div className="bg-white w-full p-10 rounded-[0px_0px_32px_32px] max-md:max-w-full max-md:px-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <CourseCard 
          title="Content" 
          description="12 chapters and 20 Quizzes" 
          ...
          bgColor="bg-purple-200 p-2 rounded-full"
          sectionType="content"
        />
        
        <CourseCard 
          title="Objectives" 
          description="18 learning goals" 
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          bgColor="bg-green-200 p-2 rounded-full"
          sectionType="objectives"
        />
        
        <CourseCard 
          title="Exams & grades" 
          description="2 exam types" 
          icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          bgColor="bg-blue-200 p-2 rounded-full"
          sectionType="exams"
        />
        ...
        <CourseCard 
          ...
          bgColor="bg-teal-200 p-2 rounded-full"
          sectionType="goodtoknow"
        />
      </div>
    </div>
  );
