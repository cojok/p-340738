...
export const SidebarChat: React.FC = () => {
  return (
    <div className="flex min-w-60 items-stretch flex-wrap h-full max-md:max-w-full">
      ...
      <div className="bg-white flex min-w-[260px] flex-col items-stretch justify-center w-[512px] p-6 rounded-[32px] max-md:max-w-full max-md:px-5">
        <div className="w-full max-md:max-w-full">
          ...
          <div className="flex w-full flex-col text-sm text-[#303746] font-normal tracking-[0.25px] leading-[1.6] mt-6 max-md:max-w-full">
            <button className="self-stretch backdrop-blur-md bg-[#E5F1FA] gap-2.5 pt-[11px] pb-3 px-6 rounded-[24px_24px_24px_4px] max-md:px-5 text-left">
              Asking questions about the course content
            </button>
            <button className="self-stretch backdrop-blur-md bg-[#E5F1FA] gap-2.5 mt-2 pt-[11px] pb-3 px-6 rounded-[4px_24px_24px_4px] max-md:px-5 text-left">
              Exam Trainer
            </button>
            <button className="self-stretch backdrop-blur-md bg-[#E5F1FA] gap-2.5 mt-2 pt-[11px] pb-3 px-6 rounded-[4px_24px_24px_4px] max-md:px-5 text-left">
              Deep Dialog Learning
            </button>
            <button className="self-stretch backdrop-blur-md bg-[#E5F1FA] gap-2.5 mt-2 pt-[11px] pb-3 px-6 rounded-[4px_24px_24px_24px] max-md:px-5 text-left">
